...
//   },
// ];
const ProductsSectionThree = ({ productSectionThreeProducts }) => {
  return (
    <section id="productSectionOne">
      <SectionTitle title={"Just For You"} />
      <div className="productsContainer">
        {productSectionThreeProducts &&
          productSectionThreeProducts?.length > 0 &&
          productSectionThreeProducts?.map((product) => (
